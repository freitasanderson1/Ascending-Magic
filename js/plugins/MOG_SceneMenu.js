...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_SceneMenu');
	...
	Moghunter.scMenu_NameFontSize = Number(Moghunter.parameters['Name FontSize'] || 24);
	...
	Moghunter.scMenu_ComNameFontSize = Number(Moghunter.parameters['Com Name FontSize'] || 40);
	...
	Moghunter.scMenu_playTimeNumberFontSize = Number(Moghunter.parameters['Time FontSize'] || 60);	
...
Scene_Menu.prototype.createPlayTime = function() {
    this._playTime = new Sprite(new Bitmap(220,36));
